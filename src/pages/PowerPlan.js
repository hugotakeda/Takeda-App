          ...
          <div style="display: flex; gap: 24px; align-items: flex-start;">
            ...
            <div style="flex-grow: 1;">
              ...
              <p class="text-gray" style="line-height: 1.6; margin-bottom: 24px;">
                Este plano de energia foi otimizado especificamente para extrair o máximo desempenho do seu hardware sem sacrificar a estabilidade. Ideal para jogos e aplicações pesadas.
              </p>
